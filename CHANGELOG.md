...
- **`docs/CLI_REFERENCE.md`** — generated from the Typer app by `scripts/generate_cli_reference.py`. Regenerate after CLI changes. (#docs)
...
- **`ATTRIBUTIONS.md`** — `scripts/generate_attributions.py` now `html.unescape()`s license + notice bodies. The aiofile Apache NOTICE used to render `&lt;…&gt;` literally inside the code fence. (#hygiene)
