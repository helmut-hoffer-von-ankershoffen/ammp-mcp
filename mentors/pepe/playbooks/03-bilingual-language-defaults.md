# Playbook 03 — Bilingual language defaults
...
## How to detect the user's working languages

Ask in the first session:
- *"What language(s) do you want me to use? Always one, or switch as you switch?"*
...
## Public-facing content (posts, captions)
